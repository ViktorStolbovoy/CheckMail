    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                ErrorReport.showError(getFragmentManager(), "NoSuchProviderException: " + e.getMessage());
                return false;
            }
            try {
                store.connect(mServer, mEmail, mPassword);
            } catch (MessagingException e)  {
               ErrorReport.showError(getFragmentManager(), "Can't connect: " + e.getMessage());
               return false;
            }

            Intent intent = new Intent(LoginActivity.this, SetupActivity.class);
            intent.putExtra(SetupActivity.SERVER_SETTING, mServer);
            intent.putExtra(SetupActivity.LOGIN_SETTING, mEmail);
            intent.putExtra(SetupActivity.PWD_SETTING, mPassword);
